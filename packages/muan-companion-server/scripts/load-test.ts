/**
 * Load test for `muan-companion-server` (plan 030 Step 2 / PRD §12,
 ...
 *
 * Usage:
 *   pnpm --filter muan-companion-server load-test [-- --participants=100]
 *
...
async function main() {
  ...
  console.log(`\n=== muan-companion-server load test: ${participantSockets.length} participants ===`)
...
Generated by \`pnpm --filter muan-companion-server load-test\` — re-run this
